      ...
      <div className="flip-card relative">
        ...
        >
          ...
          <div
            ...
            onClick={onFlip}
          >
            {/* 상단: 구문 + 청해 뱃지 + 듣기 버튼 + 레벨 팝오버 */}
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-1.5 min-w-0">
                <h3 className="text-base font-bold truncate">{expr.expression}</h3>
                ...
                <button
                  onClick={(e) => { e.stopPropagation(); speak(expr.expression) }}
          ...
          <DialogContent className="max-w-sm" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="py-2 space-y-3">
              <p className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">{expr.expression}</span>의 의미가 잘못되었나요?
              </p>
